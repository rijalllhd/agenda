            ...
            <div class="container">
                ...
                <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="get">
                    <div class="form-group">
                            <div class="row mt-3">
                                <div class="col-2"><a href="tambahmapel.php" class="btn btn-success  text-white">Tambah Data</a></div>
                            </div>
                    </div>                  
                </form>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    while ($data = mysqli_fetch_array($hasil)) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $data["inisialMapel"]; ?></td>
                            <td><?php echo $data["namaMapel"]; ?></td>
                            <td class="text-center">
                                <form action="" method="post">
                                    <a href="editmapel.php?kodeMapel=<?= $data['kodeMapel'] ?>" class="btn btn-primary text-white btn-sm mb-1">Edit</a>
                                    <a href="hapusmapel.php?kodeMapel=<?= $data['kodeMapel'] ?>" class="btn btn-danger text-white btn-sm" onclick="return confirm('apakah anda yakin untuk menghapus?');">Hapus</a>
