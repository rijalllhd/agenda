            ...
            <div class="container text-center dash position-relative">
                ...
                <div class="row mb-2">
                    <div class="col p-4 mx-3 text-center rounded-4"  style="background:rgb(20, 54, 122);">
                        <a href="_bukuinduk/bukuinduk.php" class="text-white text-decoration-none ">
                    ...
                    <div class="col p-4 mx-3 text-center rounded-4"  style="background:rgb(20, 54, 122);">
                        <a href="_datasiswa/datasiswa.php" class="text-white text-decoration-none ">
                    ...
                    <div class="col p-4 mx-3 text-center rounded-4"  style="background:rgb(20, 54, 122);">
                        <a href="_dataguru/dataguru.php" class="text-white text-decoration-none ">
                ...
                <div class="row mb-2">
                    <div class="col p-4 mx-3 text-center rounded-4"  style="background:rgb(20, 54, 122);">
                        <a href="_jurusandankelas/jurusandankelas.php" class="text-white text-decoration-none ">
                    ...
                    <div class="col p-4 mx-3 text-center rounded-4"  style="background:rgb(20, 54, 122);">
                        <a href="_mapel/mapel.php" class="text-white text-decoration-none ">
                    ...
                    <div class="col p-4 mx-3 text-center rounded-4"  style="background:rgb(20, 54, 122);">
                        <a href="_jadwalpelajaran/jadwal.php" class="text-white text-decoration-none ">
                ...
                <div class="row w-50 position-absolute bottom-0 start-50 translate-middle-x ">
                    <div class="col p-4 mx-3 text-center rounded-4"  style="background:rgb(20, 54, 122);">
                        <a href="_agendajurnal/agenda.php" class="text-white text-decoration-none ">
