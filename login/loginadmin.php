...
if(isset($_POST['submit'])){
    ...
    $select = mysqli_query($db, "SELECT * FROM admin WHERE noTelp = '$notelp' AND password = '$password'") or die('query failed');
 
    if(mysqli_num_rows($select) > 0){
       $row = mysqli_fetch_assoc($select);
       $_SESSION['kodeAdmin'] = $row['kodeAdmin'];
    ...
    <section id="hero">
        <div class="hero container">
            <div>
                ...
                <a href="loginadmin.php" type="button" class="cta">Admin</a>
                <a href="loginguru.php" type="button" class="cta">Guru</a>
            </div>
        </div>


        <div class="wrapper" id="wrapper">
            <button type="button" class="cancel" ><a href="../index.php">
